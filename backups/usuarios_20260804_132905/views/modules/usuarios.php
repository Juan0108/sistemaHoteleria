              ...
              <?php
               ...
               if($_SESSION["Perfil"] =="Soporte Tecnico"){
                ...
                foreach ($Usuarios as $key => $value) {  
                  ...
                  $estatusTexto = isset($value["Estatus"]) ? trim($value["Estatus"]) : "";
                  $estatusUsuario = ($idEstatus === 2 || strtoupper ($estatusTexto) === "inhabilitado") ? "Inhabilitado" : "Activo";
                  echo '
                  <tr>
                    ...
                    <td><button class="btn btn-warning btn-xs"><i class="fa fa-frown-o"></i></button>'.$estatusUsuario.'</td>
                    <td>
                      <div class="btn-group">
                        ...
                        <button class="btn btn-danger btnSuspender" idUsuario="'.$value["id_usuario"].'"><i class="fa fa-times"></i> </button>
                        <button class="btn btn-warning btnReset" idUsuario="'.$value["id_usuario"].'"><i class="fa fa-unlock"></i> </button>
